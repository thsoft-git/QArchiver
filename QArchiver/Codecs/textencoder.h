...
const int cp_count = 28;
const char code_pages[cp_count][2][64] = {
    {"",      "System"},
    {"IBM850", "Western European (IBM-850)"},
    {"IBM852", "Central European (IBM-852)"},
    {"IBM855", "MS-DOS Cyrillic (IBM-855)"},
    {"CP866", "Russian (CP-866)"},
    {"KOI8-R", "Russian (KOI8-R)"},
    {"KOI8-U", "Ukrainian (KOI8-U)"},
    {"UTF-8", "Unicode (UTF-8)"},
    {"CP1250", "ANSI Central European (Windows-1250)"},
    {"CP1251", "ANSI Cyrillic (Windows-1251)"},
    {"CP1252", "ANSI Latin 1; Western European (Windows-1252)"},
    {"CP1253", "ANSI Greek (Windows-1253)"},
    {"CP1254", "ANSI Turkish (Windows-1254)"},
    {"CP1255", "ANSI Hebrew (Windows-1255)"},
    {"CP1256", "ANSI Arabic (Windows-1256)"},
    {"CP1257", "ANSI Baltic (Windows-1257)"},
    {"CP1258", "ANSI/OEM Vietnamese (Windows-1258)"},
...
public:
    ...
    #ifdef Q_OS_WIN
    static wchar_t *CodePageToUnicode(UINT codePage, const char *sz);
    static char *UnicodeToCodePage(UINT codePage, const wchar_t *src);
    #endif

    static int multiByteToUtf8(const char *instr, const char *charset, char **utf8, int *utf8_len);
    static int utf8ToMultiByte(const char *instr, const char *charset, char **out, int *out_len);

    #ifdef Q_OS_WIN
    static QByteArray toLocat8BitOEM(const QString& str);
    #endif

    static void findCodecs();
    static QString decodeName (const QByteArray &fileName, const QString &codepage);
    static QByteArray encodeName(const QString &fileName, const QString &codepage);
};
...
eading to data corruption. For the most consistent results, applications should use Unicode,
